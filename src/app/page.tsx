...
export default function Dashboard() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-8 font-sans text-slate-100">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-10 xl:px-12 space-y-12">
        <div className="rounded-[1.25rem] border border-slate-800 bg-slate-900/95 p-4 shadow-[0_40px_80px_-40px_rgba(56,189,248,0.35)] ring-1 ring-sky-400/10 backdrop-blur-sm">
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-10 xl:px-12">
        <div className="grid gap-6 lg:grid-cols-[1.8fr_0.95fr] overflow-hidden mt-10">
                ...
                {sortedByRasio.slice(0, 8).map((daerah) => (
                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-wrap gap-2 text-xs text-slate-300">
                      ...
                      <span className="rounded-full bg-slate-950/90 px-3 py-1 ring-1 ring-slate-800">
                        {daerah.rekomendasi || "Tidak perlu"}
                      </span>
                    </div>
                  </div>
                ))}
